                                                ...
                                                <tr>
                                                    <td class="hide-for-mobile" style="padding:30px 0 10px 0;">
                                                        <img width="40" height="31"
                                                            src="https://www.filepicker.io/api/file/GNoaqKTQX6VXtdvaywb1"
                                                            alt="logo" />
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td class="hide-for-mobile" height="80" valign="top">
                                                        <b>
                                                            <span>AlienYard</span>
                                                        </b>
                                                        <br>
                                                        <span>Av 27 de Febrero 449, Santo Domingo 10149</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="355">
                                                        <h1>
                                                            Factura:
                                                            <span>
                                                                {{$factura->tipo_factura}}-{{$factura->no_factura}}
                                                            </span>
                                                        </h1>
                                                        <h2>
                                                            <span>
                                                                {{$factura->fecha_impresion}}
                                                            </span>
                                                        </h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="355">
                                                        <table class="data-table" cellpadding="0" cellspacing="0">
                                                            ...
                                                            {{-- termina ejemplo. reemplazar por Foreach --}}
                                                            <tr>
                                                                <th>
                                                                    Fecha
                                                                </th>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 315px;" align="left">
                                                                                <img width="59" height="22"
                                                                                    src="https://www.filepicker.io/api/file/vXIourdhTGSGGKdcdKgr"
                                                                                    alt="Pagado">
                                                                            </td>
                                                                        </tr>
                                                                        {{-- <tr>
